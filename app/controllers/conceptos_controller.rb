class ConceptosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @concepto.save
        ...
        format.json { render action: 'show', status: :created, location: @concepto }
      else
  ...
  private
    ...
    def concepto_params
      params.require(:concepto).permit(:codigo, :cantidad, :unidad, :descripcion, :valorunitario, :importe, :remision_id)
    end
end
